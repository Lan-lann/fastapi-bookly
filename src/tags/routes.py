...
from src.books.schema import Book, BookDetailModel, BookTagsModel
...
@tags_router.post("/book/{book_uid}/tags", response_model=BookTagsModel, dependencies=[user_role_checker])
